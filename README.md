...
- **🐛 Report bugs**: [GitHub Issues](https://github.com/yourusername/game-sales-analysis/issues)
- **💡 Suggest features**: [GitHub Discussions](https://github.com/yourusername/game-sales-analysis/discussions)
